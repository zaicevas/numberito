...
import { Slide, SingleGuess } from '../types/index';
...
interface SvgBullProps {
  width: number;
  height: number;
}

const SvgBull: React.FC<SvgBullProps> = ({ width, height }) => (
  ...
  example: (
    <>
      <View style={styles.guess}>
        {renderGuess({ input: '5290', bulls: 2, cows: 1 })}
      </View>
