        ...
        return (
            <View style={[styles.KeyboardStyle]}>
                <View style={[styles.container, { width: WIDTH }]}>
                    {this.getKeyboard().map((keyboard, index) => (this.renderTouchable(keyboard, this.props, index)))}
                </View>
            </View>
        );
    }
...
const styles = StyleSheet.create({
    container: {
        ...
        alignItems: 'center', justifyContent: 'center', marginHorizontal: 13, marginVertical: 8,
    }, KeyboardStyle: {
        paddingTop: 50, alignItems: 'center',
    }, CodeStyle: {
        flexDirection: 'row', alignItems: 'flex-end', justifyContent: 'space-between', height: 20,
    }, CercleStyle: {
        height: 17, width: 17, borderRadius: 17 / 2,
    }, CercleColor: {
        borderRadius: 100, position: 'absolute', bottom: 0, height: 17,
    }, textDeleteButton: {
